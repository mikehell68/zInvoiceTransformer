...
namespace ZinvoiceTransformer.XmlModels
{
    ...
    public partial class InvoiceImportTemplatesTemplateDetailFields
    {

        private InvoiceImportTemplatesTemplateDetailFieldsField[] fieldField;
        ...
        public InvoiceImportTemplatesTemplateDetailFieldsField[] Field
        {
            get
            {
